...
// Count account creation requests
$requestsQuery = "SELECT COUNT(*) AS requests FROM pending_users WHERE role = 'user'";
$requestsStmt = $conn->prepare($requestsQuery);
$requestsStmt->execute();
$requestsCount = $requestsStmt->fetch(PDO::FETCH_ASSOC)['requests'];

// Count approved account creation requests excluding admin
$approvedQuery = "SELECT COUNT(*) AS approved FROM users WHERE role = 'user'";
