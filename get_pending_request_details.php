...
$isPastDue = $claimUntilDate < $now;

// Only mark as past due if still 'to be claimed'
$request['is_past_due'] = $isPastDue && $request['request_status'] === 'to be claimed';
