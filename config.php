...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS admin_staff (
        ...
        role ENUM('super_admin', 'admin', 'health_staff') NOT NULL,
    ...
    $sql = "CREATE TABLE IF NOT EXISTS medicine_requests (
        ...
        reason TEXT,
        request_status ENUM('pending', 'to be claimed', 'claimed', 'declined', 'cancelled', 'unclaimed') NOT NULL DEFAULT 'pending',
